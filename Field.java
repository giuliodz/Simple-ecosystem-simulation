...
public class Field
{
    ...
    /**
     * Get a random free location in the field.  
     * @return a random free location anywhere in the field (not necessarily adjacent).
     */
    public Location getFreeLocation()
    {
        int x = rand.nextInt(depth);
        int y = rand.nextInt(width);
        if (field [x][y] == null){
            Location location = new Location (x,y);
            return location;
        }
        else return getFreeLocation();
    }
